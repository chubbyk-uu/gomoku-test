...
AI_ROOT_RERANK_TOP_K: int = 8  # 根节点完整重排的候选数，默认与普通节点一致
...
AI_QUIESCENCE_MAX_PLY: int = 8  # 静稳搜索最大额外 ply，仅扩展高优先级战术手
AI_QUIESCENCE_MAX_CANDIDATES: int = 3  # 静稳搜索每层最多扩展的战术候选数
